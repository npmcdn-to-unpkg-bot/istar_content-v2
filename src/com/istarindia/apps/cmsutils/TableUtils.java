...
public class TableUtils {
	...
	public static StringBuffer getTableHeader(String title, String[] headers, ArrayList<ArrayList<String>> items, int count) {
		...
		out.append("<div class='panel panel-yellow margin-bottom-40' style='margin: 30px'> <div class='panel-heading'> <h3 class='panel-title'>"
				+ "<i class='fa fa-tasks'></i> "+title+"</h3> </div>");
		out.append("<div class='panel-body'></div>");
		out.append("<table class='table table-striped table-bordered display responsive nowrap' id='datatable_fixed_column' width='80%' "
