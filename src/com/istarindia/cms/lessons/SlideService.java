...
public class SlideService {
	...
	public CMSLesson addTextTreeSlideToLesson(CMSLesson lesson, String title, String slideTransition, String backgroundColor, String backgroundTransition, CMSList treeList) {
		CMSSlide slide = new CMSSlide();
		slide.setBackground(backgroundColor);
		slide.setBackgroundTransition(backgroundTransition);
		slide.setTransition(slideTransition);
	...
	public CMSLesson addTextTableSlideToLesson(CMSLesson lesson, String title, String slideTransition, String backgroundColor, String backgroundTransition, CMSHTMLTable table) {
		CMSSlide slide = new CMSSlide();
		slide.setBackground(backgroundColor);
		slide.setBackgroundTransition(backgroundTransition);
		slide.setTransition(slideTransition);
	...
	public CMSLesson add2Text2TableSlideToLesson(CMSLesson lesson, String title, String slideTransition, String backgroundColor, String backgroundTransition, CMSHTMLTable table, String title2, CMSHTMLTable table2) {
		CMSSlide slide = new CMSSlide();
		slide.setBackground(backgroundColor);
		slide.setBackgroundTransition(backgroundTransition);
		slide.setTransition(slideTransition);
	...
	public CMSLesson addTextTableParagraphSlideToLesson(CMSLesson lesson, String title, String slideTransition, String backgroundColor, String backgroundTransition, CMSHTMLTable table, String paragraph) {
		CMSSlide slide = new CMSSlide();
		slide.setBackground(backgroundColor);
		slide.setBackgroundTransition(backgroundTransition);
		slide.setTransition(slideTransition);
	...
	public void addTextSlideToLesson(String teacherNotes, String studentNotes, Presentaion ppt, String title, String slideTransition, String backgroundColor, String backgroundTransition) {
	...
	public void addTextAndParaGraphSlideToLesson(String teacherNotes, String studentNotes, Presentaion ppt, String title, String slideTransition, String backgroundColor, String backgroundTransition, String paragraph) {
		CMSSlide cMSlide = new CMSSlide();
		cMSlide.setBackground(backgroundColor);
		cMSlide.setBackgroundTransition(backgroundTransition);
		cMSlide.setTransition(slideTransition);
	...
	public void addTextListSlideToLesson(String teacherNotes, String studentNotes, Presentaion ppt, String title, String slideTransition, String backgroundColor, String backgroundTransition, CMSList list) {
		{
			CMSSlide cMSlide = new CMSSlide();
			cMSlide.setBackground(backgroundColor);
			cMSlide.setBackgroundTransition(backgroundTransition);
	...
	public void addTextSlideToLessonUpdate(String teacherNotes, String studentNotes, Presentaion ppt, String title, String slideTransition, String backgroundColor, String backgroundTransition, String slideID) {
	...
	public void addTextAndParaGraphSlideToLessonUpdate(String teacherNotes, String studentNotes, Presentaion ppt, String title, String slideTransition, String backgroundColor, String backgroundTransition, String paragraph, String slideID) {
		CMSSlide cMSlide = new CMSSlide();
		cMSlide.setBackground(backgroundColor);
		cMSlide.setBackgroundTransition(backgroundTransition);
		cMSlide.setTransition(slideTransition);
	...
	public void addTextListSlideToLessonUpdate(String teacherNotes, String studentNotes, Presentaion ppt, String title, String slideTransition, String backgroundColor, String backgroundTransition, CMSList list, String slideID) {
		CMSSlide cMSlide = new CMSSlide();
		cMSlide.setBackground(backgroundColor);
		cMSlide.setBackgroundTransition(backgroundTransition);
		cMSlide.setTransition(slideTransition);
	...
	public void addTextImageSlideToLessonUpdate(String teacherNotes, String studentNotes, Presentaion ppt, String title, String slideTransition, String backgroundColor, String backgroundTransition, CMSImage image, String slideID) {
		CMSSlide cMSlide = new CMSSlide();
		cMSlide.setBackground(backgroundColor);
		cMSlide.setBackgroundTransition(backgroundTransition);
		cMSlide.setTransition(slideTransition);
