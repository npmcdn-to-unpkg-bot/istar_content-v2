...
/**
 * Servlet implementation class TaskCreatedForReviewerController
 */
@WebServlet("/task_created_for_reviewer")
public class TaskCreatedForReviewerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TaskCreatedForReviewerController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Lesson> lessons= new LessonService().getAllLessonForReviewer( StatusTypes.CREATED);
		...
		request.getRequestDispatcher("/content_reviewer/created_lesson.jsp").forward(request, response);
	}
