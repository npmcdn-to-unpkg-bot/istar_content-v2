...
/**
 * Servlet implementation class DraftLEssonForCreatorController
 */
@WebServlet("/draft_lesson_creator")
public class DraftLEssonForCreatorController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DraftLEssonForCreatorController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//id, lessonName, session, module, course,  review_by, mark completed	
		//these values can be accessed in jsp page to render the data 
		List<Lesson> lessons= new LessonService().getAllLessonAssignedTO_ContentCreator(user.getId(), StatusTypes.DRAFT);
