...
/**
 * Servlet implementation class TaskToPublishedForReviewerController
 */
@WebServlet("/task_to_published_for_reviewer")
public class TaskToPublishedForReviewerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TaskToPublishedForReviewerController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Lesson> lessons= new LessonService().getAllLessonForReviewer( StatusTypes.REQUEST_FOR_PUBLISH);
		...
		request.getRequestDispatcher("/content_reviewer/not_published_lesson.jsp").forward(request, response);
	}
