...
/**
 * Servlet implementation class TaskCompletedForReviewerController
 */
@WebServlet("/task_completed_for_reviewer")
public class TaskCompletedForReviewerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TaskCompletedForReviewerController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Lesson> lessons= new LessonService().getAllLessonForReviewer( StatusTypes.COMPLETED);
