...
/**
 * Servlet implementation class TaskPublishedForReviewerController
 */
@WebServlet("/task_published_for_reviewer")
public class TaskPublishedForReviewerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TaskPublishedForReviewerController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Lesson> lessons= new LessonService().getAllLessonForReviewer( StatusTypes.PUBLISHED);
		...
		request.getRequestDispatcher("/content_reviewer/published_lesson.jsp").forward(request, response);
	}
