    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="container-fluid height-1000"
                ...
                <div class="row">
                    <form action="/content/batch_controller?_action=savestudents" id="sky-form4" class="sky-form" method="post">
                            ...
                            <div class="alert alert-warning fade in text-center">
                                <div class='row pie-progress-charts margin-bottom-60'>
                                    <div class='panel panel-yellow margin-bottom-40' style='margin: 10px;    margin: 10px;border: 3px solid #FFC107;'>
                                        <div class='panel-heading'> <h3 class='panel-title'><i class='fa fa-tasks'></i> Student Listing </h3> </div><div class='panel-body'></div>
                                        ...
                                        <table class='table table-striped table-bordered display responsive  dataTable datatable_report' style='width: 98%;margin-left: 1%;margin-right: 1%;' id='datatable_report_' data-graph_type='' data-graph_title=''  data-graph_containter='report_container_' >
                                            ...
                                            <th style='max-width:100px !important; word-wrap: break-word;'>Name</th>
                                            <th style='max-width:100px !important; word-wrap: break-word;'>&nbsp;</th>
                                            </thead>
                                            <tbody>

                                                <c:forEach items="${studentList}" var="item">
                                                    <c:if test="${stList.contains(item.id)}">
                                                        <tr>
                                                            <td style='max-width:100px !important; word-wrap: break-word;'>${count}</td> <td style='max-width:100px !important; word-wrap: break-word;'>${item.name}</td><td style='max-width:100px !important; word-wrap: break-word;'> <input type="checkbox" name="obj_${item.id}" checked="checked"/></td>
                                                        </tr>
                                                    </c:if>
                                                    <c:if test="${!stList.contains(item.id)}">
                                                        <tr>
                                                            <td style='max-width:100px !important; word-wrap: break-word;'>${count}</td> <td style='max-width:100px !important; word-wrap: break-word;'>${item.name}</td><td style='max-width:100px !important; word-wrap: break-word;'><input type="checkbox" name="obj_${item.id}" /></td>
                                                        </tr>
                                                    </c:if>
                                ...
                                <section>
                                    <div >
                                        <button type="submit" class="btn-u"  >Update Batch-Group Students</button>
                                    </div>
                                </section>
