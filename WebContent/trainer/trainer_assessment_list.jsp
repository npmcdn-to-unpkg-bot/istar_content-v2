...
<!--<![endif]-->
<head>
<title> Trainer List | iStar CMS</title>
	...
	<div class="wrapper">
		...
		<div class="container-fluid height-1000" style="padding: 0px !important">
			<div class="col-md-12">
				...
				conditions.put("trainer_id", request.getParameter("trainer_id"));
				%>
				<%=(new ReportUtils()).getReport(101, conditions, ((IstarUser)request.getSession().getAttribute("user")), "TRAINER").toString() %>
			</div>
		</div>
