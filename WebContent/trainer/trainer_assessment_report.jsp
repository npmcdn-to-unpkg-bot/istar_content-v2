...
String assesment_id = request.getParameter("assessment_id");
%>
<!DOCTYPE html>
...
<!--<![endif]-->
<head>
<title> Trainer Assessment Report | iStar CMS</title>
	...
	<div class="wrapper">
		...
		<div class="container-fluid height-1000" style="padding: 0px !important">
			<div class="col-md-12">
				...
				conditions.put("assessment_id", assesment_id);
				String table=(new ReportUtils()).getReport(102, conditions, ((IstarUser)request.getSession().getAttribute("user")), "TRAINER").toString() ;
				table = table.replace(", <", "<"); //To remove the last comma from "Selected Options" column members
				%>
