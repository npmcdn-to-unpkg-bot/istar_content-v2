...
<body>
	...
	<div class="wrapper">
		...
		<div class="container-fluid height-1000" style="padding: 0px !important">
			<div class="row">
				<div class="col-md-6">
					<form action="/content/review_lesson" id="sky-form4" class="sky-form">
						...
						<fieldset>
							...
							<section>
								...
								<input readonly="readonly" value="<%=lesson.getTitle() %>" type="text" name="title" placeholder="Title of Lesson"> <b class="tooltip tooltip-bottom-right">The title of the lesson</b>
								</label>
							</section>

							<section>
								<label>Duration of Lesson</label> <label class="input"> <input readonly="readonly"  value="<%=lesson.getDuration() %>" type="number" name="duration" placeholder="Duration of Lesson"> <b class="tooltip tooltip-bottom-right">The duration of the lesson</b>
								</label>
							</section>
							<section>
								<label> Tags</label> <label class="input"> <input readonly="readonly"  data-role="tagsinput" value="<%=lesson.getTags() %>" type="text" name="Tags" class="tagcontainer" placeholder="Tags of Lesson"> <b class="tooltip tooltip-bottom-right">The tags of the lesson</b>
								</label>
							</section>
							
							<section>
								<label> Review Comments</label> <label class="input"> 
<textarea rows="3" name="review_notes" placeholder=" Please enter text" id="teacher_notes" ></textarea>								</label>
							</section>
						</fieldset>
