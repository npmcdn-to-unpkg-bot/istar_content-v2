...
<!--<![endif]-->
<head>
<title> Disapproved Lessons | iStar CMS</title>
	...
	<div class="wrapper">
		...
		<div class="container-fluid height-1000" style="padding: 0px !important">
			<div class="col-md-12">
				...
				conditions.put("content_reviewer_id",((IstarUser)request.getSession().getAttribute("user")).getId().toString());
				%>
				<%=(new ReportUtils()).getReport(43, conditions, ((IstarUser)request.getSession().getAttribute("user")), "LESSON").toString() %>
			</div>
		</div>
