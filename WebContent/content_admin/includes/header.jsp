					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="<%=baseURL %>content_admin/course_structure.jsp">View Course Structure</a></li>
						...
						<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li class="dropdown-submenu">
									...
									<ul class="dropdown-menu">
										<li><a href="page_about2.html">Create Presentation </a></li>
										<li><a href="page_about3.html">Presentation List</a></li>
									</ul>
								</li>
								<!-- End About Pages -->
								...
								<li class="dropdown-submenu">
									...
									<ul class="dropdown-menu">
										<li><a href="page_services.html">Create Game</a></li>
										<li><a href="page_services1.html">Game List</a></li>
								...
								<li class="dropdown-submenu">
									...
									<ul class="dropdown-menu">
										<li><a href="page_contact1.html">Create Assessment</a></li>
										<li><a href="page_contact2.html">Assessment List</a></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li class="dropdown-submenu">
									...
									<ul class="dropdown-menu">
										<li><a href="blog_large_right_sidebar1.html">Images</a></li>
										<li><a href="blog_large_left_sidebar1.html">Videos</a></li>
								...
								<li class="dropdown-submenu">
									...
									<ul class="dropdown-menu">
										<li><a href="blog_medium_right_sidebar1.html">Image Gallery</a></li>
										<li><a href="blog_medium_left_sidebar1.html">video Gallery</a></li>
