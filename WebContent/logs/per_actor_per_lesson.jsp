	...
	<div class="wrapper">
		...
		<div class="container-fluid height-1000" style="padding: 0px !important">
			<div class="col-md-12">
				...
				{
					conditions.put("session_id",request.getParameter("session_id"));
					conditions.put("user_id",user_string.split(";;")[1]);
					%>
					
				<%=(new ReportUtils()).getReport(176, conditions, ((IstarUser)request.getSession().getAttribute("user")), "LESSON").toString() %>
