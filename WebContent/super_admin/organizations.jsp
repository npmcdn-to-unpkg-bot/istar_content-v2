<%@page import="com.istarindia.apps.services.OrganizationService"%>
				...
				<jsp:include page="includes/sidebar.jsp"></jsp:include>	
					...
					<div class="panel panel-red margin-bottom-40">
								<div class="panel-heading">
									<h3 class="panel-title"><i class="fa fa-edit"></i>List of Organizations</h3>
								</div>
								<table class="table table-striped table-bordered" width="100%" id="datatable_fixed_column">
									...
									<tbody>
										...
										<% for(Organization org : (new OrganizationService()).getAllOrgs()) { %>
										<tr>
											<td><%=org.getId() %></td>
											<td><%=org.getName() %></td>
											<td><%=org.getOrgType() %></td>
											<td><%=org.getAddress().getPincode().getCity()%></td>
											<td><%=org.getAddress().getPincode().getState()%></td>
											
											<td><%=org.getAddress().getPincode().getCountry()%></td>
											<td><%=org.getMaxStudents() %></td>
											<td><button class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</button></td>
										</tr>
										<% } %>
									</tbody>
								</table>
