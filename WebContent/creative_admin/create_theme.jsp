			...
			<div class="container-fluid height-1000" style="padding: 0px !important">
				<div class="col-md-6">
					...
					<div class="row">
						...
						<header>THEME NAME</header>
						
						<div class="row">
							<fieldset>
								<section class="col col-md-6">
						<label class="input"> <input type="text" name="name" placeholder="Please enter new theme name">
						</label>
						...
						<div class="row">
							<fieldset>
								<section class="col col-4">
									<label class="label"><%=key.toUpperCase() %> Font Size </label> <label class="input"> 
										<input type="number" min="60" max="200" name="<%=key %>_____size" value="60">
									</label>
								</section>

								<section class="col col-4">
									<label class="label"><%=key.toUpperCase() %> Line height</label> <label class="input"> 
										<input type="number" name="<%=key %>_____line_height" step="0.1" min="1" max="3" value="1">
									</label>
								</section>

								<section class="col col-4">
									<label class="label"><%=key.toUpperCase() %> Font Weight</label> <label class="input"> 
										<input type="number" name="<%=key %>_____font_weight" step="100" min="100" max="900" value="100">
									</label>
								</section>

								<section class="col col-4">
									<label class="label"><%=key.toUpperCase() %> text alignment</label> <label class="select"> <select name="<%=key %>_____text_alignment">
								...
								<section class="col col-2">
									<label class="label"><%=key.toUpperCase() %> Color</label> <label class="select"> <input type="color" name="<%=key %>_____color" value="#000000">
									</label>
								</section>
